...
为了进一步调查这些信号的上游通路, 研究基于扰动效应进行了基因集富集分析. 根据Hallmark of Cancer, 首先被注意到的是上皮间质转化(EMT)和Hedgehog传导通路的异常强化(图2B, E), 通过对通路所含的基因表达施加扰动, 我们生成了配对的假样本, 并可注意到, 在细胞系, 或是真实的患者中, 假样本总会得到偏乐观的估计(图2C, F). Hedgehog通路的异常激活提示了异常的神经细胞发育, Hedgehog/Gli1信号通路的活性也是GBM患者TMZ抵抗的一个重要靶点. 另外, 我们还观察到细胞系中TGF-β信号通路获悉活性对于识别药物相应状态的显著性, 但其在LGG队列中未通过假设检验. 
